...
!  revision log :
! 
!  05.04.2004	ggu	written from scratch
!  23.03.2010    ggu     changed v6.1.1
!  15.11.2011	ggu	new routine taylor_set_config() and taylor_set_param()
!  23.11.2011	ggu	rcol for colored lines
...
!  this routine must be called at the beginning of a taylor plot
...
!  this routine must be called at the end of a taylor plot
...
!  initializes taylor routines (internal routine, do not call explicitly)
...
! *****************************************************************
!  next only for compatibility ... do not use anymore
! *****************************************************************
...
! *****************************************************************
!  finished compatibility section
! *****************************************************************
...
!  sets configuration parameters for plot
...
!  gets configuration parameters for plot
...
!  writes text (centered) at data point
...
!  writes text with point at data point
...
!  plots correlation coefficient (lines and ticks)
...
!  shows usage of taylor routines
...
! *****************************************************************
! 
!  to test the taylor routines uncomment the following three lines
! 
! *****************************************************************
