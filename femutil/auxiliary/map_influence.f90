...
! 24.02.1999    ggu     use n2int for node number translation
! 03.12.2001    ggu     cleaned up, hakata bay
! 18.06.2009    ggu     re-written for map of influence
! 05.11.2010    ggu     write all conz to one file, bug fix in vert_aver()
! 16.12.2010    ggu     restructured to use volume file
! 10.11.2011    ggu     call to init_volume() changed for hybrid levels
!
!****************************************************************

	program distribu_deb

! creates map of influence
...
!	   -------------------------------------------------------
!	   all state variables read for one time step -> elaborate
!	   -------------------------------------------------------
...
!---------------------------------------------------------------
! compute average concentration over whole simulation
!---------------------------------------------------------------
...
! compute dominant discharge and put index in valri
