...
! matrix inversion administration (Gaussian elimination - traditional)
!
! revision log :
!
! 12.01.2009	ggu	new file for system routines
! 31.01.2009	ggu	prepared for double precision, new aux vect vs1v,...
! 31.01.2009	ggu	prepared for double precision, new aux vect vs1v,...
...
! 15.12.2015	ggu	added dummy subroutines for 3d case
...
!******************************************************************
!
! to change from real to double precision
! change amat here and vs*v in common.h
!
!******************************************************************
