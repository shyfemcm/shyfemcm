...
!  tests the internal coordinates and distances
...
!  tests the internal coordinates and paths in one triangle
...
!  tests the internal coordinates and paths in one triangle and plot
...
!  tests conversion routines from and to internal coordinates
