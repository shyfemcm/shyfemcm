...
!===============================================================
	...
	public :: stack_info		!call stack_info(id)
     ...
     &                          ,stack_peek_i
        ...
        INTERFACE stack_get_entries
        MODULE PROCEDURE         stack_get_entries_d &
     &                          ,stack_get_entries_r &
     &                          ,stack_get_entries_i
        END INTERFACE
...
!******************************************************************
	...
	if( error == empty_error ) then
	  ...
	  stop 'error stop stack: stack holds more entries than array size'
	else
...
!--------------------
	...
	subroutine stack_get_entries_i(id,n,values)
	integer id
	integer n
	integer values(:)
	integer nsize
	...
	end subroutine stack_get_entries_d
