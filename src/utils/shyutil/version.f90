...
!
! \newcommand{\VERSION}{8.0.4}
! \newcommand{\version}{8\_0\_4}
! \newcommand{\COMMIT}{2024-03-12}
!
! DOCS	END
	...
	logical, save		:: bshort = .false.
        ...
        character*10, parameter :: version = '8.0.4'
        character*10, parameter :: commit  = '2024-03-12'
