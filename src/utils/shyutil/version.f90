...
!
! \newcommand{\VERSION}{8.0.5}
! \newcommand{\version}{8\_0\_5}
! \newcommand{\COMMIT}{2024-04-11}
!
! DOCS	END
	...
	logical, save		:: bshort = .false.
        ...
        character*10, parameter :: version = '8.0.5'
        character*10, parameter :: commit  = '2024-04-11'
